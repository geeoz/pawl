...
/** Review attribute in web element.
  * @param name   of attribute to verify
  * @param driver web driver to use
  */
final class Attribute(name: String)
